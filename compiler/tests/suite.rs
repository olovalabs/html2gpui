use html2gpui::html::collect_script_text;
use html2gpui::types::{Child, TplPart};
use html2gpui::{
    compile_sources, env_init, invoke, parse_script, split_template, strip_script_imports, Value,
};
use scraper::Html;
